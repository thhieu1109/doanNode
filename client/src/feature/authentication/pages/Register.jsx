...
function Register(props) {
    ...
    const handleSubmitRegister = (e) => {
        ...
        if (registerData.password !== registerData.confirmPassword) {
            alert("Pass word is not match");
            return;
        }

        axios.post(`http://localhost:3000/api/admin/users/register`, registerData)
            .then((res) => {
                console.log(res);
    ...
    return (
        ...
        <div>
            <div className="login-page">
                {/* ================= LEFT PANEL (giữ nguyên như Login) ================= */}
                ...
                <div className="login-right">
                    <div className="login-form-wrap">
                        ...
                        <div className="form-field">
                            ...
                            <input className="form-input" type="text" placeholder="Nguyen Van A" name="name" onChange={handleInputChange} />
                        </div>
                        ...
                        {/* Register button */}
                        <button className="btn-login" onClick={handleSubmitRegister}>Register</button>
